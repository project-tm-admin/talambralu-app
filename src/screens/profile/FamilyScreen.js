...
export default function FamilyScreen() {
  ...
  const handleContinue = async () => {
    await save({
      family: {
        fatherProfession: fatherProf,
        motherProfession: motherProf,
        brothers: parseInt(brothers, 10) || 0,
        sisters:  parseInt(sisters,  10) || 0,
        location: familyLoc,
      },
    });
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.copilotCard} activeOpacity={0.7}>
          <View style={styles.copilotIcon}><ParentIcon /></View>
...
const styles = StyleSheet.create({
  ...
  copilotCard: {
    ...
    borderColor: T.hair, borderRadius: 16, padding: 16, gap: 12, marginTop: 8,
  },
  copilotIcon: {
  ...
  laterChip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 100, borderWidth: 1, borderColor: T.hair2 },
