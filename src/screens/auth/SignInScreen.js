/**
 * Sign-In screen — Phone and Apple auth.
 */
...
const styles = StyleSheet.create({
  ...
  telugu: { fontFamily: FONTS.display, fontSize: 14, color: MAROON, marginBottom: 6 },
  heading: {
  ...
  sub: { fontSize: 13, color: T.mute, lineHeight: 20 },
  ...
  footerText: { fontSize: 14, color: T.mute },
  footerLink: { fontSize: 14, fontWeight: '700', color: MAROON },
});
